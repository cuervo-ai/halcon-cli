...
use cuervo_core::traits::EmbeddingProvider;
...
impl HybridRetriever {
    ...
    pub async fn retrieve(&self, query: &str, top_k: usize) -> Result<Vec<ScoredEntry>> {
        ...
        let mut entry_map: HashMap<uuid::Uuid, cuervo_storage::MemoryEntry> = HashMap::new();
...
mod tests {
    ...
    use cuervo_storage::{AsyncDatabase, Database, MemoryEntry, MemoryEntryType};
