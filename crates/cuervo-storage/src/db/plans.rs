...
impl Database {
    ...
    pub fn save_plan_steps(
        ...
        for (i, step) in plan.steps.iter().enumerate() {
            ...
            .map_err(|e| CuervoError::DatabaseError(format!("save plan step: {e}")))?;
        }
    ...
    pub fn load_plan_steps(&self, plan_id_prefix: &str) -> Result<Vec<PlanStepRow>> {
        ...
        let mut stmt = conn
            ...
            .map_err(|e| CuervoError::DatabaseError(format!("prepare load_plan_steps: {e}")))?;
        ...
        let rows = stmt
            ...
            .map_err(|e| CuervoError::DatabaseError(format!("load plan steps: {e}")))?
            .filter_map(|r| r.ok())
            .collect();
    ...
    pub fn update_plan_step_outcome(
        ...
        .map_err(|e| CuervoError::DatabaseError(format!("update plan step outcome: {e}")))?;
...
mod tests {
    ...
    fn test_plan(plan_id: Uuid) -> cuervo_core::traits::ExecutionPlan {
