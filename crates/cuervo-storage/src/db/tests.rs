...
use cuervo_core::types::{DomainEvent, EventPayload, Session, TokenUsage};
    ...
    fn save_replan_preserves_parent_id() {
        ...
        let original = cuervo_core::traits::ExecutionPlan {
        ...
        let replan = cuervo_core::traits::ExecutionPlan {
