...
pub fn render(
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        if !is_connected {
            ...
            ui.colored_label(CuervoTheme::TEXT_MUTED, "Loading runtime configuration...");
        } else {
            ...
            ui.horizontal(|ui| {
                ...
                if state.config_dirty {
                    ui.colored_label(CuervoTheme::WARNING, "Unsaved changes");
                }
            });
        ...
        // ── Danger Zone ─────────────────────────────────────────
        ui.label(RichText::new("Danger Zone").strong().color(CuervoTheme::ERROR));
        ui.add_space(4.0);
        if ui
            .button(RichText::new("Shutdown Runtime").color(CuervoTheme::ERROR))
            .clicked()
        {
...
fn build_update_request(cfg: &RuntimeConfigResponse) -> cuervo_client::UpdateConfigRequest {
    cuervo_client::UpdateConfigRequest {
